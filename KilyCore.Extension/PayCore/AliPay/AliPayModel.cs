...
namespace KilyCore.Extension.PayCore.AliPay
{
    public static class AliPayModel
    {
        ...
        public const string ReturnUrl = @"http://system.cfda.vip/StaticHtml/AliPayNotify.html";
        public const string NotifyUrl = @"http://system.cfda.vip/StaticHtml/AliPayNotify.html";
