...
{
    public class GovtRiskMap : IEntityTypeConfiguration<GovtRisk>
    {
        public void Configure(EntityTypeBuilder<GovtRisk> builder)
        {
            builder.ToTable(typeof(GovtRisk).Name);
