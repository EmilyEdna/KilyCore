...
namespace KilyCore.Nethereums
{
    public class NethereumUtil
    {
        ...
        #region 区块链案例展示
        static public async Task GetProtocolVersionBlock(Web3 web3)
        {
        ...
        static public async Task GetMaxBlockBlock(Web3 web3)
        {
        ...
        static public async Task ScanTxBlock(Web3 web3, ulong startBlockNumber, ulong endBlockNumber)
        {
        ...
        static public async Task GetAccountBalanceBlock(Web3 web3, string accountAddress)
        {
        ...
        /// <returns></returns>
        static public async Task ListPersonalAccountsBlock(Web3 web3)
        {
        ...
        /// <returns></returns>
        static public async Task SendEtherBlock(Web3 web3, string fromAddress, string fromPassword, string toAddress, long amountWei)
        {
        ...
        /// <returns></returns>
        static public async Task WaitForTxReceiptBlock(Web3 web3, string txHash)
        {
        ...
        static public async Task InteractWithExistingContractBlock(Web3 web3, string fromAddress, string fromPassword, string contractAddress, string contractAbi)
        {
        ...
        static public async Task InteractWithExistingContractWithEventsBlock(Web3 web3, string fromAddress, string fromPassword, string contractAddress, string contractAbi)
        {
        ...
        static public async Task GetAllChangesBlock(Web3 web3, string fromAddress, string fromPassword, string contractAddress, string contractAbi)
        {
        ...
        static public async Task GetContractValuesHistoryUniqueOffsetValueBlock(Web3 web3, string contractAddress, HexBigInteger recentBlockNumber, ulong numberBlocks, int offset)
        {
            ...
            for (ulong blockNumber = (ulong)recentBlockNumber.Value; blockNumber > (ulong)recentBlockNumber.Value - numberBlocks; blockNumber--)
            {
                ...
                if (valueAtOffset != previousValue)
                {
                    ...
                    for (int storageOffset = 0; storageOffset < offset + 2; storageOffset++)
                    {
                        ...
                        Console.WriteLine("value:\t" + blockNumber.ToString() + " " + storageOffset.ToString() + " " + valueAt + " " + HEXHelper.ConvertHex(valueAt.Substring(2)));
                    }
